...
{
    class ConnectionOdbc : IConnection
    {
        OdbcConnection Conn = null;
        OdbcTransaction Trans = null;

        internal ConnectionOdbc()
        {
            Conn = new OdbcConnection();
        }

        internal ConnectionOdbc(string connectionString)
        {
        ...
        {
            get { return new OdbcConnectionStringBuilder(); }
        }

        public ConnectionTypes ConnectionType
        {
            get { return ConnectionTypes.Odbc; }
        }
